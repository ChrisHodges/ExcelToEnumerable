...
namespace ExcelToEnumerable.Exceptions
{
    public class ExcelToEnumerableCellException : ExcelToEnumerableRowException
    {
        ...
        public ExcelToEnumerableCellException(object unmappedObject, int row, int column, object cellValue, string propertyName, IDictionary<string, object> rowValues, 
            string validationMessage = null, Exception innerException = null, ExcelToEnumerableValidationCode? excelToEnumerableValidationCode = null)
            :
            base(unmappedObject, 
